...
class ResourceLoader {
  ...
  /// Resolves the root directory of the dash_panel package by reading package_config.json.
  ///
    ...
    for (final configPath in configPaths) {
      ...
      try {
        ...
        for (final pkg in packages) {
          if (pkg['name'] != 'dash_panel') continue;
  ...
  static Future<ResourceLoader> initialize() async {
    ...
    if (resourcesDir == null) {
      throw StateError(
        'Could not find dash_panel resources directory. '
        'Make sure you have run `dart pub get` and that the dash_panel package '
